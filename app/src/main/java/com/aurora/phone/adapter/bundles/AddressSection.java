...
public class AddressSection extends Section {

    private Context context;
    private List<Address> wrapperArrayList;
    private String header;

    public AddressSection(Context context, List<Address> wrapperArrayList, String header) {
    ...
    public void onBindItemViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        final Address contactWrapper = wrapperArrayList.get(position);
        contentHolder.line1.setText(contactWrapper.getLabelName());
        contentHolder.line2.setText(contactWrapper.getMainData());
        contentHolder.img.setImageDrawable(context.getDrawable(R.drawable.ic_map));
    }
